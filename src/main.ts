...
import { FULL_RECRUITMENT_WITH_ECHO, VEGA_ECHO_CODEX_ENTRY } from "./game/commanders/cmd021TaliaVega";
...
const roster = new RosterRuntime(FULL_RECRUITMENT_WITH_ECHO, STARTING_COMMANDER_IDS);
