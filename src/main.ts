...
import { FULL_RECRUITMENT_WITH_STARLANCER, ORION_STARLANCER_CODEX_ENTRY } from "./game/commanders/cmd017LucienOrion";
...
const roster = new RosterRuntime(FULL_RECRUITMENT_WITH_STARLANCER, STARTING_COMMANDER_IDS);
