...
import { FULL_RECRUITMENT_WITH_TITAN, VOLKOV_TITAN_CODEX_ENTRY } from "./game/commanders/cmd018IvanVolkov";
...
const roster = new RosterRuntime(FULL_RECRUITMENT_WITH_TITAN, STARTING_COMMANDER_IDS);
