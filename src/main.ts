...
import { FULL_RECRUITMENT_WITH_CHRONOMANCER, VEX_CHRONOMANCER_CODEX_ENTRY } from "./game/commanders/cmd010AurelionVex";
...
const roster = new RosterRuntime(FULL_RECRUITMENT_WITH_CHRONOMANCER, STARTING_COMMANDER_IDS);
