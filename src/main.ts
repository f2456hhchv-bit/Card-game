...
import { DRAKE_SENTINEL_CODEX_ENTRY, FULL_RECRUITMENT_WITH_SENTINEL } from "./game/commanders/cmd026RonanDrake";
...
const roster = new RosterRuntime(FULL_RECRUITMENT_WITH_SENTINEL, STARTING_COMMANDER_IDS);
