...
import { FULL_RECRUITMENT_WITH_SINGULARITY, KAIN_SINGULARITY_CODEX_ENTRY } from "./game/commanders/cmd015ZephyrKain";
...
const roster = new RosterRuntime(FULL_RECRUITMENT_WITH_SINGULARITY, STARTING_COMMANDER_IDS);
