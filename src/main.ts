...
import { FULL_RECRUITMENT_WITH_HORIZON, ROSS_HORIZON_CODEX_ENTRY } from "./game/commanders/cmd023ElianaRoss";
...
const roster = new RosterRuntime(FULL_RECRUITMENT_WITH_HORIZON, STARTING_COMMANDER_IDS);
