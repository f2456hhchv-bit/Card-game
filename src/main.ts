...
import { FULL_RECRUITMENT_WITH_ORACLE, MYRR_ORACLE_CODEX_ENTRY } from "./game/commanders/cmd019SeleneMyrr";
...
const roster = new RosterRuntime(FULL_RECRUITMENT_WITH_ORACLE, STARTING_COMMANDER_IDS);
