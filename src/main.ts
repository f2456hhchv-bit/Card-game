...
import { AETHER_CELESTIAL_CODEX_ENTRY, FULL_RECRUITMENT_WITH_CELESTIAL } from "./game/commanders/cmd030LysandraAether";
...
const roster = new RosterRuntime(FULL_RECRUITMENT_WITH_CELESTIAL, STARTING_COMMANDER_IDS);
