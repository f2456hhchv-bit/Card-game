...
import { ASH_TEMPEST_CODEX_ENTRY, FULL_RECRUITMENT_WITH_TEMPEST } from "./game/commanders/cmd011ValenAsh";
...
const roster = new RosterRuntime(FULL_RECRUITMENT_WITH_TEMPEST, STARTING_COMMANDER_IDS);
