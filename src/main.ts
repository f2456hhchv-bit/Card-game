...
import { FULL_RECRUITMENT_WITH_BIOFORGE, SYN_BIOFORGE_CODEX_ENTRY } from "./game/commanders/cmd013MiraSyn";
...
const roster = new RosterRuntime(FULL_RECRUITMENT_WITH_BIOFORGE, STARTING_COMMANDER_IDS);
