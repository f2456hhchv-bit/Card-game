...
const BIOME_REGISTRY: readonly BiomeDef[] = [...SANDBOX_BIOMES, HUMAN_FRONTIER_BIOME, CRYSTAL_EXPANSE_BIOME, MACHINE_EXPANSE_BIOME, VOID_EXPANSE_BIOME, ANCIENT_CORE_BIOME, SOLAR_WASTES_BIOME];
