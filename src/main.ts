...
import { FULL_RECRUITMENT_WITH_CATALYST, RHEM_CATALYST_CODEX_ENTRY } from "./game/commanders/cmd022DariusRhem";
...
const roster = new RosterRuntime(FULL_RECRUITMENT_WITH_CATALYST, STARTING_COMMANDER_IDS);
