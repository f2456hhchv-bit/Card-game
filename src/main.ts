...
import { FULL_RECRUITMENT_WITH_NANOFORGE, ORIS_NANOFORGE_CODEX_ENTRY } from "./game/commanders/cmd025XantheOris";
...
const roster = new RosterRuntime(FULL_RECRUITMENT_WITH_NANOFORGE, STARTING_COMMANDER_IDS);
