...
import { FULL_RECRUITMENT_WITH_PHOTON, SOLARI_PHOTON_CODEX_ENTRY } from "./game/commanders/cmd014RheaSolari";
...
const roster = new RosterRuntime(FULL_RECRUITMENT_WITH_PHOTON, STARTING_COMMANDER_IDS);
