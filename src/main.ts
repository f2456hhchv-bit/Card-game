...
import { FULL_RECRUITMENT_WITH_ALCHEMIST, HELIX_ALCHEMIST_CODEX_ENTRY } from "./game/commanders/cmd027SoraHelix";
...
const roster = new RosterRuntime(FULL_RECRUITMENT_WITH_ALCHEMIST, STARTING_COMMANDER_IDS);
