...
import { DRAKE_HUNTER_CODEX_ENTRY, FULL_RECRUITMENT_WITH_HUNTER } from "./game/commanders/cmd005KaelDrake";
...
const codexRuntime = new CodexRuntime([...SANDBOX_CODEX_ENTRIES, LYRA_VOSS_CODEX_ENTRY, KANE_VANGUARD_CODEX_ENTRY, RYKER_ENGINEER_CODEX_ENTRY, CAEL_WEAVER_CODEX_ENTRY, DRAKE_HUNTER_CODEX_ENTRY]);
...
const roster = new RosterRuntime(FULL_RECRUITMENT_WITH_HUNTER, STARTING_COMMANDER_IDS);
