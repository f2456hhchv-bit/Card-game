...
import { FULL_RECRUITMENT_WITH_DIPLOMAT, SOLACE_DIPLOMAT_CODEX_ENTRY } from "./game/commanders/cmd024KieranSolace";
...
const roster = new RosterRuntime(FULL_RECRUITMENT_WITH_DIPLOMAT, STARTING_COMMANDER_IDS);
