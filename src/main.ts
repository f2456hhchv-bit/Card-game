...
import { FULL_RECRUITMENT_WITH_PHANTOM, KORVEN_PHANTOM_CODEX_ENTRY } from "./game/commanders/cmd012NyxKorven";
...
const roster = new RosterRuntime(FULL_RECRUITMENT_WITH_PHANTOM, STARTING_COMMANDER_IDS);
