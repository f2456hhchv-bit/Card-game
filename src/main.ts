...
import { FULL_RECRUITMENT_WITH_ARCHITECT, NOVA_ARCHITECT_CODEX_ENTRY } from "./game/commanders/cmd020CaelusNova";
...
const roster = new RosterRuntime(FULL_RECRUITMENT_WITH_ARCHITECT, STARTING_COMMANDER_IDS);
